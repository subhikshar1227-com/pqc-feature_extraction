...
class CanonicalPreprocessor:
    ...
    def _multi_threshold_segmentation(self, img: np.ndarray) -> np.ndarray:
        ...
        _, final_mask = cv2.threshold(evidence_normalized, PREPROCESSING_EVIDENCE_NORMALIZATION_THRESHOLD, 255, cv2.THRESH_BINARY)
        
        # CRITICAL: Find ALL significant components, including border-touching
        ...
        combined_mask = np.zeros_like(final_mask)
